...
const PROVIDERS = {
  zhipu: { label: '智谱 GLM', base: 'https://open.bigmodel.cn/api/paas/v4', style: 'openai',
    models: ['glm-4.7', 'glm-4.6', 'glm-4-flash'], note: 'open.bigmodel.cn 控制台 API Key（按量付费）' },
  ...
  kimi: { label: 'Kimi · 月之暗面', base: 'https://api.moonshot.cn/v1', style: 'openai',
    models: ['kimi-k2-0905-preview', 'moonshot-v1-128k', 'moonshot-v1-32k'], note: 'platform.moonshot.cn' },
  qwen: { label: '通义千问', base: 'https://dashscope.aliyuncs.com/compatible-mode/v1', style: 'openai',
    models: ['qwen-max', 'qwen-plus', 'qwen-turbo'], note: '阿里云百炼 bailian.console.aliyun.com' },
  doubao: { label: '豆包 · 火山方舟', base: 'https://ark.cn-beijing.volces.com/api/v3', style: 'openai',
    models: [], note: '模型填接入点 Endpoint ID（ep- 开头），方舟控制台获取' },
  siliconflow: { label: '硅基流动', base: 'https://api.siliconflow.cn/v1', style: 'openai',
    models: ['deepseek-ai/DeepSeek-V3', 'Qwen/Qwen2.5-72B-Instruct'], note: 'cloud.siliconflow.cn，新户有免费额度' },
  openrouter: { label: 'OpenRouter', base: 'https://openrouter.ai/api/v1', style: 'openai',
    models: ['deepseek/deepseek-chat', 'anthropic/claude-sonnet-4.5', 'google/gemini-2.5-flash'], note: 'openrouter.ai 一个 Key 调全球模型' },
  gemini: { label: 'Gemini', base: 'https://generativelanguage.googleapis.com/v1beta/openai', style: 'openai',
    models: ['gemini-2.5-pro', 'gemini-2.5-flash'], note: 'aistudio.google.com 生成 API Key（需能访问 Google）' },
  claude: { label: 'Claude · Anthropic', base: 'https://api.anthropic.com', style: 'anthropic',
    models: ['claude-sonnet-4-5', 'claude-opus-4-5', 'claude-haiku-4-5-20251001'], note: 'console.anthropic.com' },
  ...
  openai: { label: 'OpenAI', base: 'https://api.openai.com/v1', style: 'openai', cors: false,
    models: ['gpt-5', 'gpt-4o', 'gpt-4o-mini'], note: '⚠️ 官方接口禁浏览器直连：请勾选「自定义」，填中转站地址' },
